...
- The Map view can switch between the existing 2D projection and a CesiumJS WGS-84 3D globe. The first 3D phase renders satellites at true altitude and shares live simulation time and satellite selection with the 2D map.
