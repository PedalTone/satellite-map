...
- Analysis Lab includes a seven-day ground-access tool for any satellite in the loaded set. The user can enter a station latitude/longitude or select the station on the map, choose a minimum elevation, and receive rise/set times, duration, maximum elevation, peak range, and summary gap metrics.
